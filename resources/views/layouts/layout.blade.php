                        ...
                        <v-tabs right>
                            ...
                            <v-tab>
                                ...
                                <v-menu bottom origin="center center" transition="scale-transition" open-on-hover
                                    ...
                                    <v-list>
                                        <v-list-item style="text-decoration: none" link exact
                                            :to="{name: 'health-workers'}">
                            ...
                            <v-tab style="text-decoration: none" link exact :to="{name: 'user.resources'}">
                                <v-icon left> mdi-hammer-screwdriver </v-icon> Resources
                            </v-tab>
                            <v-tab style="text-decoration: none" link exact :to="{name: 'user.contactUs'}">
                                <v-icon left> mdi-phone-classic </v-icon> Contact Us
                            </v-tab>
                        </v-tabs>
                        <v-btn style="text-decoration: none" link exact :to="{{route('login')}}" large rounded
                            class="primary ml-5 text-capitalize" text small>
                            Login
