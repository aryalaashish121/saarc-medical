                        ...
                        <v-card flat class="py-5">
                            <v-row>
                                <v-col cols="12" sm="12" md="6" lg="4">
                                    <v-card :loading="internLoading" elevation="4" outlined rounded="xl">
                                        ...
                                        <v-card-subtitle class="title">Available Positions:</v-card-subtitle>
                                        <v-card-text>
                                            <v-chip-group v-model="internPostSelect"
                                                active-class="blue-grey darken-2 white--text" column>
                                                <v-chip>
                                ...
                                <v-col cols="12" sm="12" md="6" lg="4">
                                    <v-card :loading="exchangeLoading" elevation="4" outlined rounded="xl">
                                        <template slot="progress">
                                        ...
                                        <v-card-text>
                                            <v-chip-group v-model="exchangePostSelect"
                                                active-class="deep-purple darken-2 white--text" column>
                                                <v-chip>
                                                    <v-icon left class="mr-2"> mdi-account-outline</v-icon>
                                                    Doctor
                                                </v-chip>
                                ...
                                <v-col cols="12" sm="12" md="6" lg="4">
                                    <v-card elevation="4" outlined rounded="xl">
                                        ...
                                        <v-card-text>
                                            <v-chip-group v-model="vacancySelect" active-class="green darken-2 white--text"
                                                column>
                                                <v-chip>
                                                    <v-icon left class="mr-2"> mdi-account-outline</v-icon>
                                                    Manager
