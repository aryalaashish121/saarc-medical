            ...
            <v-card flat outlined rounded="lg" class="mt-3 py-10 px-15">
                  ...
                  <v-row class="mt-3">
                    <v-col cols="12" md="4">
                      ...
                      >
                        ...
                        <v-date-picker
                          ...
                          "
                          @input="
                            (menu = false), ConvertADtoBS(form_fields.dob_ad)
                          "
                          min="1950-01-01"
                          @change="save"
                        ></v-date-picker>
                    ...
                    <v-col cols="12" md="4">
                      <v-text-field
                        ...
                        dense
                        @input="
                          (menu = false), ConvertBStoAD(form_fields.dob_bs)
                        "
                      ></v-text-field>
                    </v-col>
                  </v-row>
              ...
              <v-card-text>
                  ...
                  <v-checkbox v-model="checkbox">
                    <template v-slot:label>
                      <div class="mt-4">
                        ...
                        responsibility to provide all necessary documents to
                ...
                <v-row>
                  ...
                  regarding my Membership. I have read and understood the
                  SAARCMC rules and regulation and stated in the rules book and
                  the condition there of and I promise to abide by the said
  ...
  methods: {
    ...
    async apply() {
      ...
      self.$refs.observer.validate().then(async (result) => {
        ...
        await axios
          .post(`${self.url}`, self.form_fields)
          .then((response) => {
